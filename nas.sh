...
# NAS project dir: /volume2/Docker/AlpacaHedgeFund  (mounted as /app in container meridian-fund)
#
# Examples:
#   ./nas.sh "docker compose -f /volume2/Docker/AlpacaHedgeFund/docker-compose.yml ps"
#   ./nas.sh "docker exec meridian-fund sh -c 'cd /app && python3 run_scoring.py'"
